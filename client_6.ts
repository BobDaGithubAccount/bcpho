(function() {
const canvas = document.getElementById('challenge6_canvas') as HTMLCanvasElement;
const ctx = canvas.getContext('2d')!;
ctx.translate(canvas.width / 2, canvas.height / 2);
const gravityInput = document.getElementById('challenge6_gravity') as HTMLInputElement;
const fixedXInput = document.getElementById('challenge6_fixedX') as HTMLInputElement;
const fixedYInput = document.getElementById('challenge6_fixedY') as HTMLInputElement;
const heightInput = document.getElementById('challenge6_height') as HTMLInputElement;
const telemetry = document.getElementById('challenge6_telemetry') as HTMLInputElement;
