"use strict";
(function () {
    const canvas = document.getElementById('challenge6_canvas');
    const ctx = canvas.getContext('2d');
    ctx.translate(canvas.width / 2, canvas.height / 2);
    const gravityInput = document.getElementById('challenge6_gravity');
    const fixedXInput = document.getElementById('challenge6_fixedX');
    const fixedYInput = document.getElementById('challenge6_fixedY');
    const heightInput = document.getElementById('challenge6_height');
    const telemetry = document.getElementById('challenge6_telemetry');
    let scale = 1;
    let offsetX = 0;
    let offsetY = 0;
