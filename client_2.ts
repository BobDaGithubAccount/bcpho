(function() {
// HTML Elements
const canvas = document.getElementById('challenge2_canvas') as HTMLCanvasElement;
const ctx = canvas.getContext('2d')!;
ctx.translate(canvas.width / 2, canvas.height / 2);

const angleInput = document.getElementById('challenge2_angle') as HTMLInputElement;
const gravityInput = document.getElementById('challenge2_gravity') as HTMLInputElement;
const speedInput = document.getElementById('challenge2_speed') as HTMLInputElement;
const heightInput = document.getElementById('challenge2_height') as HTMLInputElement;
